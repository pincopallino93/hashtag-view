...
import com.greenfrvr.hashtagview.sample.fragments.RecyclerViewFragment;
...
public class SamplesAdapter extends FragmentStatePagerAdapter {
    ...
    static {
        ...
        fragments.append(5, EventsSampleFragment.class.getName());
        fragments.append(6, StylingSampleFragment.class.getName());
        fragments.append(7, ContactsFragment.class.getName());
    }
